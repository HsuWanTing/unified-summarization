...
class Vocab(object):
  ...
  def __init__(self, vocab_file, max_size):
    ...
    self._unk_id = self._word_to_id[UNKNOWN_TOKEN]
    self._pad_id = self._word_to_id[PAD_TOKEN]
    self._start_id = self._word_to_id[START_DECODING]
    self._stop_id = self._word_to_id[STOP_DECODING]

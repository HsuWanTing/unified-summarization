...
def attention_decoder_one_step(decoder_input, prev_state, encoder_states, caption_state, enc_padding_mask, cell, \
  ...
  with variable_scope.variable_scope("attention_decoder") as scope:
    ...
    x = linear([decoder_input] + [prev_context] + [caption_state], input_size, True)

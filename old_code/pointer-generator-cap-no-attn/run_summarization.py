...
tf.app.flags.DEFINE_integer('max_cap_steps', 200, 'max timesteps of encoder (max source text tokens)')
...
def main(unused_argv):
  ...
  hparam_list = ['max_cap_steps','training_method', 'use_baseline', 'mode', 'lr', 'adagrad_init_acc', 'rand_unif_init_mag', 'trunc_norm_init_std', 'max_grad_norm', 'hidden_dim', 'emb_dim', 'batch_size', 'max_dec_steps', 'max_enc_steps', 'coverage', 'cov_loss_wt', 'pointer_gen']
  hps_dict = {}

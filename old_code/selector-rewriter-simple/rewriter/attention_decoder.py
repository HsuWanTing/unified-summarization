...
def attention_decoder_one_step(decoder_input, prev_state, encoder_states, enc_padding_mask, cell, \
                            ...
                            sent_probs=None, enc_sent_id_mask=None):
  """
  Args:
  ...
  with variable_scope.variable_scope("attention_decoder") as scope:
      ...
      with variable_scope.variable_scope("Attention"):
        ...
        def masked_attention(e):
          ...
          if sent_probs is not None:
            ...
            sent_probs_projected = tf.gather_nd(sent_probs, indices) # shape (batch_size, attn_len)
            attn_dist *=  sent_probs_projected # shape (batch_size, attn_len)
    ...
    x = linear([decoder_input] + [prev_context], input_size, True)
